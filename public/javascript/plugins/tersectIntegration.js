    ...
    this.controls.push({
        ...
        action: function (browser) {
            ...
            function makeTersectFileMenu() {
                ...
                $('#tsi-submit-local',fileMenu).on('click',function(){fileUploader(fileMenu,"#tsi-submit-local-text","#local-file-progress","#local-file-chooser","tsi", ".gv-tersect-index-list tbody","/index/tersectUpload")});
                return fileMenu;
            }
